...
#========================================================================================#
    ...
    if has_spglib and symmetry:
                ...
                max_length = abs(57-len(mess))
                print '%s' %mess + '{0:>{width}}'.format("||", width=max_length)
                ...
                if len(symm_ops_spglib) != n_symm_ops:
                  ...
                  max_length = abs(57-len(err_mess))
                  print '%s' %err_mess + '{0:>{width}}'.format("||", width=max_length)
                  err_mess = '|| %s ' %len(symm_ops_spglib) + 'symmetry operations generated by spglib. '
                  max_length = abs(57-len(err_mess))
                  print '%s' %err_mess + '{0:>{width}}'.format("||", width=max_length)
                  print '|| CASTEP or spglib tolerance might be too tight/loose.||'
